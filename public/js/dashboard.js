...
var x = setInterval(function() {
  ...
  document.getElementById("NatalId").innerHTML = days + " Days " + hours + " Hours "
  + minutes + " Min " + seconds + " Sec ";
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("NatalId").innerHTML = "Selamat Hari Raya Natal Semuanya, Jangan Lupa Ibadah ☃️";
  }
}, 1000);
// Count Down Tahun Baru
...
var x = setInterval(function() {
  ...
  document.getElementById("NewyrsId").innerHTML = days + " Days " + hours + " Hours "
  + minutes + " Min " + seconds + " Sec ";
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("NewyrsId").innerHTML = "Selamat Hari Raya Natal Semuanya, Jangan Lupa Ibadah ☃️";
  }
}, 1000);
